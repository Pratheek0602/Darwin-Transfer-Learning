...
if __name__ == "__main__":
    ...
    test_dir = '../output/nnUNet_test_data'
    seg_dir = '/users/aca21pv/ITUNet-for-PICAI-2022-Challenge/segmentation/segout/segmentation_result'
    csv_path = '/users/aca21pv/ITUNet-for-PICAI-2022-Challenge/classification/test_3c.csv'
    if phase == 'seg':
